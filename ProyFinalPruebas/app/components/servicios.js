...
function Servicios(){
    ...
    const handleClick = () =>{
        setShowConsideraciones(!showConsideraciones);
    }
    return (
        <div >
            ...
            <div className='bg-backgroundLBlue flex flex-col items-center py-9'>
                <div className="mb-4 w-full flex flex-col items-center">
                    <button
                    type="button"
                    className="text-white bg-backgroundBlue hover:bg-darkaquaLine focus:ring-4
                    focus:ring-blue-300 font-alegreyaMedium rounded-lg text-base px-5 py-2.5 me-2 mb-2
                    dark:bg-aquaLine dark:bg-aquaLine focus:outline-none dark:focus:ring-cyan-800"
                    onClick={handleClick}
                    >
                    Consideraciones 
                    </button>
                    {showConsideraciones && <Consideraciones />}
                </div>
                <div>
                    <button
                    type="button"
